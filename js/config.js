...
export const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbwvxW24cjzf2g6DlmX2lweQohB_YtbKO03EZ_6sxAI5seUJODbLgWbCH52Ta7sIfcpS/exec";
...
export const FRASES = [
  ...
  "El equipo está listo. ¿Y tú? 💪",
  "Hoy también vamos a romperla 🔥",
  "Un día más, una oportunidad más 🎯",
  "El trabajo no se hace solo. Aquí vamos 🚀",
  "Bienvenido al set. Luces, cámara... ¡acción! 🎬",
  "Otra jornada épica comienza ⚡",
  "El talento no descansa. Ni hoy 🎧",
  "Que el café esté listo porque esto arranca 🫖",
  "Hoy es un buen día para hacer grandes cosas ✨",
  "El mundo no espera. Tampoco nosotros 🌍",
  "Se abre el telón. Es hora de brillar 🎭",
  "Creatividad activada. Let's go 🧠",
  "Cada día cuenta. Especialmente este 📅",
  "El estudio está vivo. Hora de trabajar 🎙️",
  "Modo productivo: ON 🟢",
  "El mejor momento para empezar es ahora ⏰",
  "Grandes ideas nacen de grandes jornadas 💡",
...
export const MENSAJES_ANTICIPADA = {
  ...
  2: { titulo: "¡Hasta luego, {nombre}! 👋", msg: "Psst... no olvides hablar con Angiela para cuadrar esas horas 😊", confetti: false, angiela: true },
  3: { titulo: "¡Cuídate mucho, {nombre}! 💙", msg: "Recupérate bien y nos vemos pronto. ¡Ánimo!", confetti: false, angiela: false },
  4: { titulo: "¡Ánimo, {nombre}! 🙏", msg: "Esperamos que todo esté bien. Cuídate mucho.", confetti: false, angiela: false },
  5: { titulo: "¡Hasta pronto, {nombre}! 🗓️", msg: "Acuérdate de hablar con Angiela cuando puedas para cuadrar el tiempo 😊", confetti: false, angiela: true }
};

export const MENSAJES_TARDIA = {
  1: { titulo: "¡Eres un máquina, {nombre}! 🔥", msg: "Ese video va a quedar increíble. Habla con Angiela para que te compense el tiempo extra 💪", confetti: true, angiela: true },
  2: { titulo: "¡Qué actitud la tuya, {nombre}! 🙌", msg: "El equipo lo nota. Coordina con Angiela para entrar tarde mañana o salir temprano otro día — te lo ganaste.", confetti: true, angiela: true }
};
